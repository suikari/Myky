			            ...
			            <table class="table table-hover comment-table">
			                ...
			                <tbody>
			                    <tr v-for="(comment, index) in commentList" >
			                        ...
			                        <td class="text-center">{{ boardId }}</td>
			                        <td>{{ comment.content }}</td>
			                        <td class="text-center">{{ comment.userId }}</td>
			                        <td class="text-center">{{ comment.updatedAt }}</td>
			                        <td class="text-center">
			                            <button class="btn btn-info btn-sm" @click="viewComment(comment.id)">조회</button>
			                            <button class="btn btn-danger btn-sm" @click="deleteComment(comment.id)">삭제</button>
			                        </td>
			                    </tr>
			                </tbody>
			            </table>
